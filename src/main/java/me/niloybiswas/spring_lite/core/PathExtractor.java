...
public class PathExtractor {
    ...
    public static boolean isUrlPatternMatched(String mappedUrl, String requestUrl) {
        ...
        for (int i = 0; i < mappedParts.length; i++) {
            ...
            if (!mappedParts[i].equals(requestParts[i])) {
                return false;
            }
        }
    ...
    public static Map<String, String> getPathVariables(String mappedUrl, String requestUrl) {
        String[] mappedParts = mappedUrl.split("/");
        String[] requestParts = requestUrl.split("/");
